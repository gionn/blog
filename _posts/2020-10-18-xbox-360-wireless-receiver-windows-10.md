...
there are [plenty of cheap clones](https://amzn.to/46CCC2P) of them at half the
price), we end-up with an **Unknown Device** entry on Device Manager and a
detailed message like this:
...
**Install** and enjoy your receiver working again.
